...
const products: Product[] = [
  ...
  { id: '21', name: 'Картофель "Казачок"', category: 'Картофель', weights: [20], prices: { 20: 1200 }, image: 'https://cdn.poehali.dev/files/1002862248.jpg', description: 'Среднеранний столовый сорт с красной кожурой и белой мякотью. Отличные вкусовые качества, устойчив к болезням. Универсален для любых блюд.' },
