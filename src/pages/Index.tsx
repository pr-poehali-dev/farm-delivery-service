...
const products: Product[] = [
  ...
  { id: '25', name: 'Картофель "Балтик Роуз" семенной', category: 'Картофель', weights: [10], prices: { 10: 500 }, image: 'https://cdn.poehali.dev/files/1002897457.jpg', description: 'Семенной картофель "Балтик Роуз" — сорт с яркой розовой кожурой и белой мякотью. Отличные вкусовые качества, хорошая урожайность.' },
