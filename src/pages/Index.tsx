...
const products: Product[] = [
  ...
  { id: '2', name: 'Картофель "Коломбо"', category: 'Картофель', weights: [10, 34], prices: { 10: 700, 34: 1450 }, image: 'https://cdn.poehali.dev/files/1002862244.jpg', description: 'Среднеспелый сорт с желтой мякотью. Кремовая текстура и насыщенный вкус. Сохраняет форму при варке — отлично для салатов, запекания, жарки и пюре.' },
  ...
  { id: '21', name: 'Картофель "Казачок"', category: 'Картофель', weights: [20], prices: { 20: 1200 }, image: 'https://cdn.poehali.dev/files/1000000688.jpg', description: 'Среднеранний столовый сорт с красной кожурой и белой мякотью. Отличные вкусовые качества, устойчив к болезням. Универсален для любых блюд.' },
