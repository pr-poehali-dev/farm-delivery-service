...
const products: Product[] = [
  ...
  { id: '16', name: 'Масло соевое', category: 'Заготовки', weights: [5], pricePerKg: 130, image: 'https://cdn.poehali.dev/files/1001628999.jpg', description: 'Холодный отжим без химии — зерна сои проходят пресс, масло отжимается естественным путем и фильтруется. Сохраняются ценные жиры, антиоксиданты, лецитин (до 3800мг/100гр) и витамины. Лецитин снижает холестерин, защищает печень, стимулирует мозговую деятельность. Подходит для жарки и салатов. Вредные вещества образуются только при перегревании (точка дымления).' },
