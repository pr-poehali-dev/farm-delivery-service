...
const products: Product[] = [
  ...
  { id: '12', name: 'Картофель "Королева Анна Супер Элита"', category: 'Картофель', weights: [20], pricePerKg: 70, image: 'https://cdn.poehali.dev/files/1002767412.jpg', description: 'Ранний сорт с тонкой кожурой и белой нежной мякотью. Сладковатый вкус и кремовая текстура. Превосходен для пюре, запеканок, жарки. Не разваливается — идеален для салатов.' },
