...
const products: Product[] = [
  ...
  { id: '20', name: 'Картофель "Гала Бэби"', category: 'Картофель', weights: [10, 20], pricePerKg: 80, image: 'https://cdn.poehali.dev/files/1002897457.jpg', description: 'Мелкий картофель до 4см, готовится в кожуре, как молодой. Идеален для запекания целиком с травами и специями. Нежная текстура и насыщенный вкус.' },
