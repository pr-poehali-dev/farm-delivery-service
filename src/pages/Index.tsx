...
const products: Product[] = [
  ...
  { id: '22', name: 'Картофель "Беллароза" мытый', category: 'Картофель', weights: [20], pricePerKg: 70, image: 'https://cdn.poehali.dev/projects/37d25151-dc28-4c37-b88b-0704483fea6f/files/88e86dce-8b88-4f96-b0c3-38f0e1d3f82c.jpg', description: 'Ранний сорт с красной кожурой и жёлтой мякотью. Мытый — готов к использованию. Рассыпчатый, с насыщенным вкусом. Отлично подходит для пюре, запекания и жарки.' },
