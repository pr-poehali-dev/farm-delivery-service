...
const products: Product[] = [
  ...
  { id: '16', name: 'Масло соевое', category: 'Заготовки', weights: [5], pricePerKg: 130, image: 'https://cdn.poehali.dev/files/1001628999.jpg', description: 'Холодный отжим без химических средств — сохраняет витамины, антиоксиданты и до 3800мг лецитина на 100г. Лецитин снижает холестерин, защищает печень и стимулирует мозговую деятельность. Подходит для жарки — вредные вещества образуются только при перегревании до дыма.' },
