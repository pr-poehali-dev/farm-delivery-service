...
const products: Product[] = [
  { id: '22', name: 'Картофель "Королева Анна" мытый', category: 'Картофель', weights: [10], prices: { 10: 800 }, image: 'https://cdn.poehali.dev/files/1002767412.jpg', description: 'Мытый, готов к приготовлению. Прекрасно подходит для варки и жарки. Универсальный сорт.', isNew: true },
  ...
  { id: '25', name: 'Картофель "Балтик Роуз" семенной', category: 'Картофель', weights: [10], prices: { 10: 500 }, image: 'https://cdn.poehali.dev/projects/37d25151-dc28-4c37-b88b-0704483fea6f/bucket/733d80c1-c33b-482b-ba2a-b7523e83b2d6.jpg', description: 'Семенной картофель "Балтик Роуз" — сорт с яркой розовой кожурой и белой мякотью. Отличные вкусовые качества, хорошая урожайность.' },
