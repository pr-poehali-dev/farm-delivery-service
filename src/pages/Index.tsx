...
const products: Product[] = [
  ...
  { id: '22', name: 'Картофель "Беллароза" мытый', category: 'Картофель', weights: [10], prices: { 10: 850 }, image: 'https://cdn.poehali.dev/projects/37d25151-dc28-4c37-b88b-0704483fea6f/bucket/4804b029-2005-4bba-9ac3-9a06035acef9.jpg', description: 'Ранний сорт с красной кожурой и жёлтой мякотью. Мытый — готов к использованию. Рассыпчатый, с насыщенным вкусом. Отлично подходит для пюре, запекания и жарки.', isNew: true },
