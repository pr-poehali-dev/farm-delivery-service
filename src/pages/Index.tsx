...
const products: Product[] = [
  ...
  { id: '28', name: 'Картофель молодой "Беллароза" урожай 2026г', category: 'Картофель', weights: [20], prices: { 20: 1400 }, image: 'https://cdn.poehali.dev/projects/37d25151-dc28-4c37-b88b-0704483fea6f/bucket/ad2bbd94-e25a-44a6-b0ea-7a5b3754539c.jpeg', description: 'Молодой картофель сорта Беллароза, урожай 2026 года. Нежная тонкая кожица, рассыпчатая мякоть. Прекрасно подходит для варки и запекания.', isNew: true },
