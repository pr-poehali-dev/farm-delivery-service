...
const products: Product[] = [
  ...
  { id: '2', name: 'Картофель "Коломбо"', category: 'Картофель', weights: [10, 34], prices: { 10: 700, 34: 1450 }, image: 'https://cdn.poehali.dev/files/1002767599.jpg', description: 'Среднеспелый сорт с желтой мякотью. Кремовая текстура и насыщенный вкус. Сохраняет форму при варке — идеален для первых блюд и тушения.' },
  ...
  { id: '20', name: 'Картофель "Гала" семенной', category: 'Картофель', weights: [10, 20], pricePerKg: 40, image: 'https://cdn.poehali.dev/files/1002897457.jpg', description: 'Ранний сорт, 1 репродукция. Мелкий картофель до 4см, готовится в кожуре, как молодой. Идеален для запекания целиком с травами и специями. Нежная текстура и насыщенный вкус.' },
