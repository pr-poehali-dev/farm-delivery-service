...
const products: Product[] = [
  ...
  { id: '27', name: 'Картофель молодой "Лили" урожай 2026г', category: 'Картофель', weights: [20, 35], prices: { 20: 1400, 35: 1750 }, image: 'https://cdn.poehali.dev/projects/37d25151-dc28-4c37-b88b-0704483fea6f/bucket/64821ca3-fbed-4fdd-a1d9-cf7bd1501177.jpeg', description: 'Картофель «Лили» — универсальный сорт, родственный знаменитой «Андретте». Крупные ровные клубни с коричневой шкуркой и жёлтой мякотью отлично подходят для варки, нежного пюре и запекания.', isNew: true, awaiting: true },
