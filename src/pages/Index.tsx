...
const products: Product[] = [
  ...
  { id: '22', name: 'Картофель "Беллароза" мытый', category: 'Картофель', weights: [10], prices: { 10: 800 }, image: 'https://cdn.poehali.dev/projects/37d25151-dc28-4c37-b88b-0704483fea6f/files/ba5a793d-73f7-407a-b6a8-a8f8bbffa0d3.jpg', description: 'Ранний сорт с красной кожурой и жёлтой мякотью. Мытый — готов к использованию. Рассыпчатый, с насыщенным вкусом. Отлично подходит для пюре, запекания и жарки.' },
